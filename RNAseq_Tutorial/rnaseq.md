...
20 –left ./merged_trimmed_forward.fq.gz –right
./merged_trimmed_reverse.fq.gz –min_contig_length 400 –output
./Trinity_out
...
```
    ...
    ## Old packages: 'BiocManager', 'bslib', 'callr', 'e1071', 'emmeans',
    ##   'fontawesome', 'lme4', 'maps', 'markdown', 'mclust', 'pkgload', 'processx',
    ##   'ps', 'R.utils', 'ragg', 'shiny', 'XML', 'zip'
...
This tells limma what our experiment is and how to analyze the data.
Here, we are setting females as the intercept. We have 12 females and 12
males in our dataset. Luckily, they are in order, with females first. In
our design matrix, we have set females as the intercept. If you have a
control group, then they would be set as the intercept.
...
samples. Then we will normalize our counts using the TMM method and
calculate the log counts per million (logCPM) of our gene counts.
...
```
    ...
    ## ko05014 ko05014                     Amyotrophic lateral sclerosis   120/993
    ## ko05016 ko05016                                Huntington disease   100/993
    ## ko05022 ko05022 Pathways of neurodegeneration - multiple diseases   122/993
    ## ko05012 ko05012                                 Parkinson disease    87/993
    ## ko05020 ko05020                                     Prion disease    85/993
    ## ko05010 ko05010                                 Alzheimer disease    92/993
    ##           BgRatio       pvalue     p.adjust       qvalue
    ## ko05014 280/13506 9.949456e-63 3.581804e-60 2.534493e-60
    ## ko05016 229/13506 3.825831e-53 6.886496e-51 4.872901e-51
    ## ko05022 368/13506 3.566246e-49 4.279495e-47 3.028181e-47
    ## ko05012 209/13506 3.331246e-44 2.998122e-42 2.121478e-42
    ## ko05020 209/13506 3.060957e-42 2.203889e-40 1.559477e-40
    ## ko05010 300/13506 5.135334e-34 3.081200e-32 2.180265e-32
    ##                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        geneID
